...
<div class="col-xs-12">
    <div class="box">
      <div class="box-header">
        <h3 class="box-title">Laporan Kinerja</h3>
      ...
      <div class="box-body">
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('laporan_kinerja/create'),'<i class="fa fa-plus"></i> Tambah', 'class="btn bg-purple"'); ?>
            </div>
		...
		<td  style="width: 10px;padding-left: 8px;"><input type="checkbox" name="id" value="<?= $laporan_kinerja->id;?>" />&nbsp;</td>
			<td width="80px">
                <?php echo ++$start ?></td>
