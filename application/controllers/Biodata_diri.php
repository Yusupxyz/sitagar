...
class Biodata_diri extends CI_Controller
{
    ...
    public function index()
    {
		...
		'email' => set_value('email', $row->dp_email),
        ...
        $data['code_js'] = 'biodata_diri/codejs';
        $data['page'] = 'biodata_diri/Biodata_diri_form';
    ...
    public function update_action() 
    {
		...
		'catatan_verif' => $this->input->post('catatan_verif',TRUE),
            ...
            redirect(site_url('biodata_diri'));
        }
    }
