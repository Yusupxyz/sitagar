...
class Data_pegawai extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['page'] = 'data_pegawai/Data_pegawai_list';
    ...
    public function read($id) 
    {
		...
		'tanggal_sk_awal' => $row->tanggal_sk_awal,
		'tempat_tugas' => $row->tempat_tugas,
		'no_hp' => $row->no_hp,
		'email' => $row->email,
		'status_verif' => $row->status_verif,
		'catatan_verif' => $row->catatan_verif,
	    );
        ...
        $data['page'] = 'data_pegawai/Data_pegawai_read';
        $this->load->view('template/backend', $data);
        } else {
